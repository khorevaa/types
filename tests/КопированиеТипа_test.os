...
Функция ПолучитьСписокТестов(Знач Тестирование) Экспорт
	...
	ИменаТестов.Добавить("ТестДолжен_ПроверитьКопированиеСценария");
	ИменаТестов.Добавить("ТестДолжен_ПроверитьКопированиеСценарияВРавныйТип");
...
Процедура ТестДолжен_ПроверитьКопированиеСценария() Экспорт
	
	ТестовыйСценарий = Новый ТестовыйСценарий();
	ТестовыйСценарий.Поле1 = Новый Массив();
	ТестовыйСценарий.Поле2 = "Поле1";
	
	СкопированныйТестовыйСценарий = КопированиеТипа.Скопировать(ТестовыйСценарий, , 2);
	Ожидаем.Что(ПроверкаТипа.ЭтоСценарий(СкопированныйТестовыйСценарий), "Проверка копирования типа <Сценарий> должна быть успешной").ЕстьИстина();
	Ожидаем.Что(СкопированныйТестовыйСценарий.Поле1, "Проверка копирования типа <Сценарий> должна быть успешной").Не_().Равно(ТестовыйСценарий.Поле1);
	Ожидаем.Что(СкопированныйТестовыйСценарий.Поле2, "Проверка копирования типа <Сценарий> должна быть успешной").Равно(ТестовыйСценарий.Поле2);
	
КонецПроцедуры

Процедура ТестДолжен_ПроверитьКопированиеСценарияВРавныйТип() Экспорт
	
	ТестовыйСценарий = Новый ТестовыйСценарий();
	ТестовыйСценарий.Поле1 = Новый Массив();
	ТестовыйСценарий.Поле2 = "Поле1";
	
	СценарийПриемник = Новый ТестовыйСценарий();
	
	КопированиеТипа.Скопировать(ТестовыйСценарий, СценарийПриемник, 2);
	Ожидаем.Что(ПроверкаТипа.ЭтоСценарий(СценарийПриемник), "Проверка копирования типа <Сценарий> должна быть успешной").ЕстьИстина();
	Ожидаем.Что(СценарийПриемник.Поле1, "Проверка копирования типа <Сценарий> должна быть успешной").Не_().Равно(ТестовыйСценарий.Поле1);
	Ожидаем.Что(СценарийПриемник.Поле2, "Проверка копирования типа <Сценарий> должна быть успешной").Равно(ТестовыйСценарий.Поле2);
